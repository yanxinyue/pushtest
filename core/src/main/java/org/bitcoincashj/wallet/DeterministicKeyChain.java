...
public class DeterministicKeyChain implements EncryptableKeyChain {
    ...
    public static final ImmutableList<ChildNumber> BIP44_ACCOUNT_ZERO_PATH =
            ImmutableList.of(new ChildNumber(44, true), ChildNumber.Bch145_HARDENED, ChildNumber.ZERO_HARDENED);
    // m / 44' / 1' / 0'
    public static final ImmutableList<ChildNumber> BIP44_ACCOUNT_ZERO_PATH_TEST =
            ImmutableList.of(new ChildNumber(44, true), ChildNumber.ONE_HARDENED, ChildNumber.ZERO_HARDENED);
    ...
    protected ImmutableList<ChildNumber> getAccountPath() {
        ...
        if("org.bitcoin.test".equals(context.getParams().getId())){
            return BIP44_ACCOUNT_ZERO_PATH_TEST;
        }
